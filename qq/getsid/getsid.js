...
function login(uin,pwd,p,vcode,pt_verifysession){
	...
	xiha.postData(loginurl,"uin="+uin+"&pwd="+pwd+"&p="+p+"&vcode="+vcode+"&pt_verifysession="+pt_verifysession+"&r="+Math.random(1), function(d) {
		if(d.saveOK ==0){
			...
			var backurl = "index.php?mod=addqq&my=add&qq="+uin+"&qpwd="+encodeURIComponent(pwd)+"&qsid="+d.sid+"&skey="+encodeURIComponent(d.skey)+"&pskey="+encodeURIComponent(d.pskey)+"&pskey2="+encodeURIComponent(d.pskey2);
			//alert("QQ "+uin+" 登录成功！");
